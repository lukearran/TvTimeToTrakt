...
# A method which goes through each followed show on TV Time and performs tasks to their Trakt counterpart.
# This method can be accessed by calling '2' in the menu selection.
